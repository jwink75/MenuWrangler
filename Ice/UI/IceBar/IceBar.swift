            ...
            window.publisher(for: \.frame)
                ...
                .sink { [weak self, weak window] _ in
                    guard
                        ...
                        let info = window.flatMap { win in
                            CGWindowID(exactly: win.windowNumber).flatMap { WindowInfo(windowID: $0) }
                        },
        ...
        if !ScreenCapture.cachedCheckPermissions() {
            HStack {
                ...
                Button {
                    ...
                    Text("Open MenuWrangler Settings")
                }
                .buttonStyle(.plain)
            ...
            Text("MenuWrangler cannot display menu bar items for automatically hidden menu bars")
                .padding(.horizontal, 10)
